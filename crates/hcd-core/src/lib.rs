...
pub const HCD_PATCH_SCHEMA_VERSION_24: &str = "hcd-patch/24";
pub const HCD_PATCH_SCHEMA_VERSION_25: &str = "hcd-patch/25";
pub const HCD_PATCH_SCHEMA_VERSION_26: &str = "hcd-patch/26";
pub const HCD_PATCH_SCHEMA_VERSION_27: &str = "hcd-patch/27";
pub const HCD_PATCH_SCHEMA_VERSION_28: &str = "hcd-patch/28";
pub const HCD_PATCH_SCHEMA_VERSION_29: &str = "hcd-patch/29";
...
pub const HCD_PATCH_SCHEMA_V24_JSON: &str = include_str!("../schemas/hcd-patch-24.schema.json");
pub const HCD_PATCH_SCHEMA_V25_JSON: &str = include_str!("../schemas/hcd-patch-25.schema.json");
pub const HCD_PATCH_SCHEMA_V26_JSON: &str = include_str!("../schemas/hcd-patch-26.schema.json");
pub const HCD_PATCH_SCHEMA_V27_JSON: &str = include_str!("../schemas/hcd-patch-27.schema.json");
pub const HCD_PATCH_SCHEMA_V28_JSON: &str = include_str!("../schemas/hcd-patch-28.schema.json");
pub const HCD_PATCH_SCHEMA_V29_JSON: &str = include_str!("../schemas/hcd-patch-29.schema.json");
...
mod schema_tests {
    ...
    fn frozen_json_schemas_are_valid_json_and_have_stable_ids() {
        ...
        let patch_v21: serde_json::Value =
        ...
        let patch_v24: serde_json::Value =
            serde_json::from_str(super::HCD_PATCH_SCHEMA_V24_JSON).unwrap();
        let patch_v25: serde_json::Value =
            serde_json::from_str(super::HCD_PATCH_SCHEMA_V25_JSON).unwrap();
        let patch_v26: serde_json::Value =
            serde_json::from_str(super::HCD_PATCH_SCHEMA_V26_JSON).unwrap();
        let patch_v27: serde_json::Value =
            serde_json::from_str(super::HCD_PATCH_SCHEMA_V27_JSON).unwrap();
        let patch_v28: serde_json::Value =
            serde_json::from_str(super::HCD_PATCH_SCHEMA_V28_JSON).unwrap();
        let patch_v29: serde_json::Value =
            serde_json::from_str(super::HCD_PATCH_SCHEMA_V29_JSON).unwrap();
        ...
        assert_eq!(patch_v24["$id"], "urn:officecli:hcd-patch:24");
        assert_eq!(patch_v25["$id"], "urn:officecli:hcd-patch:25");
        assert_eq!(patch_v26["$id"], "urn:officecli:hcd-patch:26");
        assert_eq!(patch_v27["$id"], "urn:officecli:hcd-patch:27");
        assert_eq!(patch_v28["$id"], "urn:officecli:hcd-patch:28");
        assert_eq!(patch_v29["$id"], "urn:officecli:hcd-patch:29");
    }
