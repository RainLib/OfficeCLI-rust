...
s.merge_cells('A4:B5')
# The current exporter rejects source view references touched by a grid shift.
s.sheet_view.selection = []
...
operations = [
    ...
    ('hcd-patch/14', 'xlsx.row.delete', {'row': 3}),
...
for rev, expected in enumerate(('A5:B6', 'A4:B5', 'B4:C5', 'A4:B5')):
